    ...
    <div className="space-y-6">
            ...
            <div key={vehicle.id} className="bg-surface-container rounded-xl overflow-hidden border border-outline-variant group hover:border-primary-container transition-all flex flex-col justify-between h-full">
              <div>
                <div className="h-48 relative overflow-hidden bg-surface-container-low">
                  ...
                  {vehicle.hidden && (
                    <div className="absolute top-4 right-4 px-3 py-1 bg-primary-container text-on-primary-container font-label-sm rounded-full text-[10px] uppercase font-bold tracking-wider">
                      Hidden
                    </div>
                  )}
                </div>
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="material-symbols-outlined text-secondary-fixed text-sm">{vehicle.battery || 'battery_full'}</span>
      ...
      {showForm && (
        <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-[100] flex items-center justify-center">
          <div className="glass-panel w-full max-w-md rounded-xl overflow-hidden shadow-2xl transform scale-95 transition-transform duration-300 mx-4">
